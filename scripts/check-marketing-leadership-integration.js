...
if (!howToMake.includes('id="ql-how-to-make"') || !howToMake.includes("المشروع المقترح") || !howToMake.includes("هدف المشروع") || !howToMake.includes("كيف نفذنا المشروع خطوة بخطوة") || !howToMake.includes("ماذا كتبنا في المشروع؟")) {
