...
if (!howToMake.includes('id="ql-how-to-make"') || !howToMake.includes("data-slide-intro") || !howToMake.includes("data-slide-summary") || !howToMake.includes("المشروع المقترح") || !howToMake.includes("EXAMPLE — المثال المكتمل") || !howToMake.includes("data-slide-next")) {
